...
public class FileUtil {
    ...
    public static int IO_BUFFER_SIZE = 64 << 10;
    ...
    public static File searchFile(File file, final String fileName, final boolean isDstIsFile) {
        ...
        JOut.T(TAG, "searchFile--->[isFile]:" + file.isFile() + " [isDir]:" + file.isDirectory());
        ...
        if (file.isDirectory()) {
            ...
            for (File f : files) {
                JOut.T(TAG, "searchFile--->for-->[path]:" + f.getAbsolutePath() + " [name]:" + f.getName()
    ...
    public static boolean checkFileMD5(File file, String md5) throws IOException {
        ...
        JOut.T(TAG, "checkFileMD5--->[file]:" + fileMD5 + " [md5]:" + md5);
    ...
    public static void deleteFileCleanly(File file) {
        ...
        if (file.isDirectory()) {
            ...
            JOut.T(TAG, "deleteFileCleanly--->" + file.getAbsolutePath() + "delete=" + res);
        }
    }
